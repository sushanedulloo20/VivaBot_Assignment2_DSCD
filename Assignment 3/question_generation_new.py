...
def main():
    ...
    if import_topics!=[]:
        ...
        #     q3=f'''Generate one different,very detailed question where a possible scenario is generated in the form of a question along with their answer (IN SEPERATE LINES) STRICTLY from the text.Question should be strictly from the topic given below:
        #                                 TOPIC:
        #                                 {topics_choosen[c]}
        #                         .Do NOT REPEAT THE PREVIOUSLY ASKED QUESTIONS '''
        #     response1=ask_question(q2,VectorStore)
        #     questions.append(response1)
        #     response2=ask_question(q3,VectorStore)
        ...
        for i in range(num_questions//2):
            ...
            q2 = f'''Generate one different, very detailed and technical question along with their answer (IN SEPARATE LINES) STRICTLY from the text. Question should be strictly from the topic given below:
                TOPIC:
                {topics_choosen[c]}
                .Do NOT REPEAT THE PREVIOUSLY ASKED QUESTIONS'''
        ...
        for i in range(num_questions- (num_questions//2)):
            if d >= len(topics_choosen):
                d = 0
                
            q3 = f'''Generate one different, very detailed question where a possible scenario is generated in the form of a question along with their answer (IN SEPARATE LINES) STRICTLY from the text. Question should be strictly from the topic given below:
                TOPIC:
                {topics_choosen[c]}
                .Do NOT REPEAT THE PREVIOUSLY ASKED QUESTIONS'''
